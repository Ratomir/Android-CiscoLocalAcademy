...
public class ConnectionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webView = (WebView)connectionView.findViewById(R.id.webViewConnection);
        webView.loadData(getString(R.string.nav_connection_text), "text/html; charset=utf-8", "utf-8");
